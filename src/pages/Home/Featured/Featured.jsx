...
const Featured = () => {
    return (
        <section className="featuredImage bg-fixed text-white pt-4 my-16">
            <SectionTitle
            subHeading={"Check it out"}
            heading={"Featured Item"}
            ></SectionTitle>
            <div className="flex justify-center items-center bg-slate-500 bg-opacity-40 pb-24 pt-12 px-36">
                <div className="w-2/3">
